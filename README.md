...
<table>
  <tr>
    ...
    <td align="center" width="33%">
      ...
      <sub>current-year contributions</sub>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center">
      ...
      <code>scardubu.dev/api/github-stats</code>
    </td>
    <td align="center">
      <strong>Update cadence</strong><br/>
      <code>24h cache</code>
    </td>
    <td align="center">
      <strong>Profile view</strong><br/>
      <a href="https://scardubu.dev" rel="noopener noreferrer">Live portfolio</a>
    </td>
  </tr>
</table>
...
> The previous SVG cards were fragile on GitHub mobile because they depended on a third-party image service and GitHub's image proxy. This version uses native Markdown/HTML so the section renders consistently.
